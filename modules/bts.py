...
class BtsModule(BaseModule):
    ...
    def add_model_specific_args(subparsers):
        ...
        parser.add_argument('--out-channels', type=int, default=10, help='Number of out channels. Either 10 or 20')
        ...
        parser.add_argument('--loss', default='silma', type=str, help='loss function')
