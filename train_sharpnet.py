...
if __name__ == "__main__":
    ...
    parser = sharpnet.SharpNetModule.add_model_specific_args(parser)
    ...
    model = sharpnet.SharpNetModule(args)
    ...
    trainer = pl.Trainer.from_argparse_args(args,
        ...
        logger=pl.loggers.TensorBoardLogger("result", name='sharpnet')
    )
