...
if __name__ == "__main__":
    ...
    parser = laina.FCRNModule.add_model_specific_args(parser)
    ...
    trainer = pl.Trainer.from_argparse_args(args,
        ...
        logger=pl.loggers.TensorBoardLogger("result", name='laina')
    )
